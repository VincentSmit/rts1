...
\begin{itemize}
\item[]\lstinputlisting[language=C,caption=#2,label=#1]{code/#1.cc}
\end{itemize}
}
...
\newcommand{\hmwkClassInstructor}{prof.dr.ir. M.J.G. Bekooij
} % Teacher/lecturer
\newcommand{\hmwkAuthorName}{S.A. Geerlings, s0201111, EMSYS} % Your name
...
\include{sections/lid_stud}

\include{sections/circ_buf}

\include{sections/hapi}
